    ...
    <div className="application-shell">
      ...
      <div className="application-main">
        ...
        <main className="workspace" tabIndex={-1}>
          ...
          /> : selected.id === 'administration' ? <AdministrationPage initialTab={administrationTab} /> : selected.id === 'policy-actions'?<PolicyActionsPage/>:selected.id==='portfolio-planning'?<PortfolioPlanningPage/>:selected.id==='predictive-governance'?<PredictiveModelGovernancePage/>:selected.id==='integrity-audit'?<IntegrityAuditPage/> : <>
