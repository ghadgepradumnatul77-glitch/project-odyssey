...
export interface AssetSummary { id: string; assetCode: string; name: string; assetType: string; departmentId: string; jurisdictionId: string; department: OrganizationRef; jurisdiction: OrganizationRef; }
